...
@Component({
  ...
  styleUrls: ['./stack-bar-graph.component.scss']
})
export class StackBarGraphComponent implements OnInit {
  ...
  // Metername = []
  // areaName: string;
  // MeterwiseArea = ['HTPCC1', 'HTPCC2', 'HTPCC3', 'HTPCC4', 'HTPCC5', 'HTPCC6', 'HTPCC7']
  // LinewiseArea = ['Compressed-Air', 'PTED', 'Sealer-Line', 'TopCoat', 'Ploshing', 'Other', '']
  ...
  renderGraph() {
    ...
    // // console.log("thuis is area --.",this.area)
    // if (this.area === 'meterwise') {
    //   this.Metername = this.MeterwiseArea
    // }
    // else {
    //   this.Metername = this.LinewiseArea
    // }
